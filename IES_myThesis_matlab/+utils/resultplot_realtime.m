function [] = resultplot_realtime(P_BalanceGen_3, P_BalanceCon_3)
    % ==================== 公共变量 ===================
    ...
    xtickformat("hh:mm")
    hold on;
    bar(time, -P_eBalanceCon_3, "stacked", 'EdgeColor', "none");
    ...
    hold on;
    bar(time, -P_hBalanceCon_3, "stacked", 'EdgeColor', "none");
    ...
    hold on;
    bar(time, -P_gBalanceCon_3, "stacked", 'EdgeColor', "none");
