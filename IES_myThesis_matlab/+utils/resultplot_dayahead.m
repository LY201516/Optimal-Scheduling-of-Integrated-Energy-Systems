function [] = resultplot_dayahead(P_BalanceGen_1, P_BalanceCon_1)
    % ==================== 电功率平衡图片 ===================
    P_eBalanceGen_1 = P_BalanceGen_1{1};    % {}为直接取出矩阵，()返回的依旧是一个元胞数组
    P_eBalanceCon_1 = P_BalanceCon_1{1};
    newcolor1 = [
    ...
    bar(P_eBalanceGen_1, "stacked", 'EdgeColor', "none"); 
    hold on;
    bar(-P_eBalanceCon_1, "stacked", 'EdgeColor', "none");
    colororder(newcolor1); 
    title('电功率平衡图', 'FontName', "SimSun", 'FontSize', 18, 'FontWeight', "bold");
    xlim([0, 25]);
    xticks(1:24);
    xlabel('时间/h', 'FontName', "SimSun", 'FontSize', 14, 'FontWeight', "bold");
    ...
    % ==================== 热功率平衡图片 ===================
    P_hBalanceGen_1 = P_BalanceGen_1{2};
    P_hBalanceCon_1 = P_BalanceCon_1{2};
    newcolor2 = ["#B092B6", "#E38D26", "#5F9C61", "#CAC1D4", "#A4C97C",...
        "#C74D26", "#F1CC74"];
    figure;
    set(gcf, 'Units', "centimeters", 'Position', [3 2 30 20]); 
    set(gca, 'Position', [0.06 0.06 0.9 0.89]);
    bar(P_hBalanceGen_1, "stacked", 'EdgeColor', "none"); 
    hold on;
    bar(-P_hBalanceCon_1, "stacked", 'EdgeColor', "none");
    ...
    % ==================== 氢功率平衡图片 ===================
    P_HBalanceGen_1 = P_BalanceGen_1{3};
    P_HBalanceCon_1 = P_BalanceCon_1{3};
    ...
    % ==================== 气功率平衡图片 ===================
    P_gBalanceGen_1 = P_BalanceGen_1{4};
    P_gBalanceCon_1 = P_BalanceCon_1{4};
    newcolor4 = ["#B092B6", "#5EA7B8", "#AED2E2",...
        "#E38D26", "#F1CC74", "#CAC1D4"];
    figure;
    set(gcf, 'Units', "centimeters", 'Position', [5 2 30 20]); 
    set(gca, 'Position', [0.06 0.06 0.9 0.89]);
    bar(P_gBalanceGen_1, "stacked", 'EdgeColor', "none"); 
    hold on;
    bar(-P_gBalanceCon_1, "stacked", 'EdgeColor', "none");
